            ...
            modelBuilder.Entity<Customer>(c =>
  {
      ...
      c.Property(b => b.BirthDay).HasColumnType("date");
           ...
           "mochoangduocthao@gmail.com"
            ...
            new Category { CategoryID = 1, CategoryName = "Laptop", Order = 1, CategoryStatus = true },
            new Category { CategoryID = 2, CategoryName = "Màn hình", Order = 4, CategoryStatus = true },
            new Category { CategoryID = 3, CategoryName = "Chuột", Order = 2, CategoryStatus = true },
            new Category { CategoryID = 4, CategoryName = "Bàn phím", Order = 3, CategoryStatus = true });
           ...
           TimeSpan.Parse("10:00:00"),
            ...
            modelBuilder.Entity<Employee>().HasData(
                ...
                new Employee
                {
                    ...
                    Name = "Hoàng Ngọc Én",
                    Gender = true,
                    BirthDay = DateTime.Parse("2003-11-29"),
