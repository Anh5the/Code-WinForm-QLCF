...
namespace QLBH
{
    public partial class fNewOrder : Form
    {
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            {
                toolTip1.Show("Thời điểm đặt hàng phải <= Thời điểm nhận hàng?",mReceiveTime, 0, 0, 1000);
                mOrderTime.Focus();
                return;
            }
            try
        ...
        private void txtReceiveAddress_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                toolTip1.Show("Địa chỉ nhận hàng - tối đa 250 ký tự?",
               txtReceiveAddress, 0, 0, 1000);
                e.Cancel = true;
            }
        }
        private void cbCustomers_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
